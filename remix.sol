...
contract TranDetail {
    ...
    function addBuyList(string[] memory _buyTime, string[] memory _oId, string[] memory _pId, uint[] memory _onePrice, uint[] memory _amount, uint[] memory _allPrice, string[] memory _sId) public returns(uint, uint) {
